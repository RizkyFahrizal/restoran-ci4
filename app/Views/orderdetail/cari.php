    ...
    <div class="col-12">
        <form action="<?= base_url('/admin/orderdetail/cari') ?>" method="POST">
            <div class="form-group col-6 float-left">
                <label for="Kategori">Awal : </label> <input type="date" name="awal" required class="form-control">
                <br>
            </div>
            <div class="form-group col-6 float-right">
                <label for="keterangan">Sampai : </label> <input type="date" name="sampai" required class="form-control">
                <br>
            </div>
